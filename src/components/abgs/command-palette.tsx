    ...
    <AnimatePresence>
      {s.paletteOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 flex items-start justify-center bg-foreground/10 p-4 pt-[15vh] backdrop-blur-xs"
          onClick={close}
        >
          <motion.div
            ...
            className="w-full max-w-xl overflow-hidden rounded-xl border border-border bg-popover/80 shadow-float"
          >
            <Command
            ...
            >
              ...
              <Command.List className="max-h-[60vh] overflow-auto p-2">
                ...
                <Command.Group
                  heading="Actions"
                  className="**[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-base **:[[cmdk-group-heading]]:text-muted-foreground"
                >
                  <Item
                    icon={Upload}
                    onSelect={() => {
...
function Item({
  ...
  return (
    <Command.Item
      onSelect={onSelect}
      className="flex cursor-pointer items-center gap-3 rounded-sm p-3 text-sm hover:bg-accent"
    >
